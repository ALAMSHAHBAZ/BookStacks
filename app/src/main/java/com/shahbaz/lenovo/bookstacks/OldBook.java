...
public class OldBook extends AppCompatActivity  implements View.OnClickListener
...
// and returned in the Activity's onRequestPermissionsResult()
    ...
    public void onClick(View v) {
        ...
        reference.setValue(BeanClass.create(name,phone,email,text,"old "+details,address,pin));
